...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $item['item_image'] ?? "./assests/products/1.png"?>" class="img-fluid">
            ...
            <div class="col-sm-6 py-5">
                ...
                <small><?php echo $item['item_branch'] ?? "Brand" ?></small>
                <div class="d-flex">
                    ...
                    <a href="#" class="px-2 font-rale font-size-14">20,534 ratings | 1000+ answerd quections</a>
                </div>
                <hr class="m-0">
